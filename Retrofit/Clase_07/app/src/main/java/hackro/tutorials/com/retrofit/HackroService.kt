...
interface HackroService{
    ...
    *Multiples parametros
     ...
     **/
    @GET(BuildConfig.ENDPOINT_USER + "?{id_user}") fun getUserPath(@Path("id_user") taskId: String) : String


    /**
     * Respuesta HTTP sin procesar
     * De esta manera indicamos que retornaremos el response sin procesar de manera sincrona
     */
